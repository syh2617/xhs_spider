    ...
    function s() {
        ...
        return function(f, I, C) {
            ...
            var D = function(r) {
                var AF = BY;
                try {
                    return r['_garp_13b78'] ? r['_garp_1b7c6'][r['_garp_96ad3']] : r[AF(0x259)];
                } catch (error) {}
            };
            var T = function(r, S) {
                var AO = BY;
                ...
                , function(S, N, Y, Z, X, p, M) {
                    ...
                    if (k[sv(fB.A)](k[sv(0x1df)], k['PfkUt'])) {
                        ...
                        var o1 = R[sv(0x28b)](k[sv(fB.G)](R[sv(fB.c)], o0), o0)['map'](D)
                            ...
                            , o3 = k['UTuQp'](D, o2);
                        try {
                            k['DTqGd'](l, o3["apply"](k[sv(0x2a4)](typeof o2[sv(0x2d4)], sv(fB.K)) ? f : o2[sv(0x2d4)], o1), C, C, 0x0);
                        } catch (e) {}
                        return ++X;
                    }
                }
...
function get_xsxt(c, i, cookie) {
    document.cookie = 'a1=' + cookie;
    return window._webmsxyw(c, i)
}
let res = get_xsxt("/api/sns/web/v2/comment/page",
    {"note_id": "64cf6397000000000800d497","cursor":"", "top_comment_id":"",
        "image_formats": ["jpg","webp","avif"]},
    "1920077820fdc39t1lcyevymyn8uce69uy41elq5950000230157"
    )
console.log(res)
//XYW_
//XYW_
//profile
//XYW_'
//"XYW_"